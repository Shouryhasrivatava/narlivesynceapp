...
const TEMPLATES = {
  brainstorm: {
    name: 'Classic Notes Setup',
    notes: [
      {
        id: 'note-1',
        title: 'Live Sync & Presence',
        content: 'Multiple tabs communicate via WebSockets / Socket.IO with sub-30ms latency!\n==Watch cursors glide across the canvas in real time!==\n- [x] WebSockets connected\n- [ ] Multi-tab test',
        x: 80,
        y: 120,
        width: 320,
        height: 240,
        ...
        updatedAt: Date.now(),
        lastEditedBy: 'System',
        lastEditedByColor: '#000000',
        zIndex: 10
      },
      {
        id: 'note-2',
        title: 'Simultaneous Edit & Merge',
        content: 'Try editing this note simultaneously in 2 tabs!\n[hl:green]Notice the live lock badge and 3-way non-destructive merging engine in action.[/hl]\n- [x] Concurrency tests passed',
        x: 430,
        y: 120,
        width: 340,
        height: 240,
        ...
        updatedAt: Date.now(),
        lastEditedBy: 'System',
        lastEditedByColor: '#3f3f46',
        zIndex: 11
      },
      {
        id: 'note-3',
        title: 'Optimistic UI Updates',
        content: 'Dragging, voting, and resizing update [hl:cyan]instantly on client state[/hl] before server acknowledgement for zero-latency feel.\n- [x] 60fps interaction',
        x: 800,
        y: 120,
        width: 310,
        height: 240,
        ...
        updatedAt: Date.now(),
        lastEditedBy: 'System',
        lastEditedByColor: '#2563eb',
        zIndex: 12
      },
      {
        id: 'note-4',
        title: 'Refresh Survival Guarantee',
        content: 'All state changes are persistently written to server disk atomically.\n[hl:yellow]Close any tab or hit F5; your canvas state is safely restored.[/hl]',
        x: 250,
        y: 400,
        width: 320,
        height: 230,
        ...
        updatedAt: Date.now(),
        lastEditedBy: 'System',
        lastEditedByColor: '#059669',
        zIndex: 13
      },
      {
        id: 'note-5',
        title: 'Classic Notes & Tasks',
        content: 'Double-click anywhere to quickly create a note, or click the toolbar button.\n[hl:pink]You can highlight text and add interactive checkboxes on the fly![/hl]',
        x: 600,
        y: 400,
        width: 320,
        height: 230,
        ...
        updatedAt: Date.now(),
        lastEditedBy: 'System',
        lastEditedByColor: '#7c3aed',
        zIndex: 14
      }
    ]
  },
  retrospective: {
    name: 'Sprint Tasks Board',
    notes: [
      {
        id: 'retro-1',
        title: 'What Went Well',
        content: 'Socket.IO integration was rock solid.\n==Reconnections worked automatically without dropped packets.==\n- [x] Sub-30ms latency\n- [x] Live presence',
        x: 100,
        y: 120,
        width: 320,
        height: 240,
