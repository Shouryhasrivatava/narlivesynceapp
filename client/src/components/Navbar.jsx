        ...
        <div className="flex items-center -space-x-1.5 overflow-hidden py-1">
          {onlineUsers.slice(0, 5).map((user) => (
            <div
              ...
              className="w-7 h-7 rounded-full border-2 border-white dark:border-zinc-900 flex items-center justify-center text-xs shadow-xs transition-transform hover:scale-110 cursor-pointer"
